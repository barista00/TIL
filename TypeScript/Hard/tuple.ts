...
let arr :[string, number, boolean] = ['치킨', 5000, true]
...
let arr2 :[string, number, ...boolean[]] = ['동서녹차', 4000, true, false, true, true, false, true]
...
type Func = [string, boolean, ...(number|string)[]]
function f (...rest :Func) {
  console.log(...rest)
}
f('문자', true, 123, 'hello');
...
function split (...rest :(string|number)[]) {
