...
// type MonsterType = { name1 : 'string',  hp : number, mp : number}
// type HeroType = { name1 : 'string', hp : number}
// type NewType = MonsterType & HeroType

// let char :NewType= { name1 : 'zㅣ존12', hp : 150, mp : 230 }
// 중복 속성이 있으면 에러발생한다 
